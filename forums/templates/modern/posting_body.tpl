    ...
    <table width="450" border="0" cellspacing="0" cellpadding="2">
      ...
      <td colspan="9"> 
        ...
        <tr> 
          ...
          <select class="genmed" name="addbbcode18" onChange="bbfontstyle('[color=' + this.form.addbbcode18.options[this.form.addbbcode18.selectedIndex].value + ']', '[/color]')" onMouseOver="helpline('s')">
          ...
          </select> &nbsp;{L_FONT_SIZE}:<select class="genmed" name="addbbcode20" onChange="bbfontstyle('[size=' + this.form.addbbcode20.options[this.form.addbbcode20.selectedIndex].value + ']', '[/size]')" onMouseOver="helpline('f')">
