  ...
  <tr> 
	<td valign="top" align="center" width="100%"> 
	  <table cellspacing="2" cellpadding="6" border="0">
		<tr valign="middle"> 
		  <!--<td>{INBOX_IMG}</td>-->
		  <td style="border: 1px solid rgb(100,100,160);"><span class="cattitle">{INBOX}</span></td>
		  <!--<td>{SENTBOX_IMG}</td>-->
		  <td style="border: 1px solid rgb(100,100,160);"><span class="cattitle">{SENTBOX}</span></td>
		  <!--<td>{OUTBOX_IMG}</td>-->
		  <td style="border: 1px solid rgb(100,100,160);"><span class="cattitle">{OUTBOX}</span></td>
		  <!--<td>{SAVEBOX_IMG}</td>-->
		  <td style="border: 1px solid rgb(100,100,160);"><span class="cattitle">{SAVEBOX}</span></td>
		</tr>
	  </table>
	</td>
	<td align="right"> 
		...
		<tr> 
		  <td colspan="3" width="100%" class="row2">
			<table cellspacing="0" cellpadding="1" border="0">
			  <tr> 
				<td bgcolor="{T_TD_COLOR2}"><img src="templates/RPGDX/images/spacer.gif" width="{INBOX_LIMIT_IMG_WIDTH}" height="8" alt="{INBOX_LIMIT_PERCENT}" /></td>
			  </tr>
			</table>
		  </td>
		</tr>
