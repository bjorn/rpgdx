	...
	$mode == 'register' )
{
	...
	if ( $mode == 'register' && isset($_POST['website']))
	{
...
if ( isset($_POST['submit']) )
{
	...
	else if ( $mode == 'register' )
	{
		...
		if ( $mode == 'register' && !isset($_POST['notabot']) || strcasecmp($_POST['notabot'], "iamnotabot") != 0)
		{
			$error = TRUE;
	...
	if ( !$error )
	{
		...
		else
		{
			...
			// Get current date
			//
			$sql = "INSERT INTO " . USERS_TABLE . "	(user_id, username, user_regdate, user_password, user_email, user_icq, user_website, user_occ, user_from, user_interests, user_sig, user_sig_bbcode_uid, user_avatar, user_avatar_type, user_viewemail, user_aim, user_yim, user_msnm, user_attachsig, user_allowsmile, user_allowhtml, user_allowbbcode, user_allow_viewonline, user_notify, user_notify_pm, user_popup_pm, user_timezone, user_dateformat, user_lang, user_style, user_level, user_allow_pm, user_lastread, user_active, user_actkey)
