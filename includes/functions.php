...
/* Tiny inline-SVG icon set for action links (edit/remove). The 2026 theme
 * shows the icon and hides the label; modern/classic hide the icon and
 * keep the historical [bracketed] text label. */
function action_icon($name)
{
	$paths = array(
		'edit'   => '<path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/>',
		'remove' => '<polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>',
	);
...
function action_link($name, $url, $attrs = array())
{
	$extra = '';
	foreach ($attrs as $key => $value) {
		$extra .= ' ' . $key . '="' . htmlspecialchars($value, ENT_QUOTES) . '"';
	}
	return '<a class="action-link action-' . $name . '" href="' . $url . '" title="' . $name . '"' . $extra . '>'
		. action_icon($name)
