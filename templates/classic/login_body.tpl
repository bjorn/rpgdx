...
<!-- END error -->
<!-- BEGIN form -->
<form action="{form.ACTION}" method="post" target="_top">
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td class="formNameCell" align="right">Username:&nbsp;</td>
		<td width="150"><input type="text" name="username" size="25" class="formInput"></td>
	</tr>
	<tr>
		<td class="formNameCell" align="right">Password:&nbsp;</td>
		<td><input type="password" name="password" size="25" class="formInput"></td>
	</tr>
</table>
<br />
