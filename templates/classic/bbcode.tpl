...
<tr> 
	  <td><span class="genmed" style="font-weight: bold">{USERNAME} wrote:</span></td>
	</tr>
	<tr>
...
<table width="90%" cellspacing="1" cellpadding="3" border="0" align="center">
<tr> 
	  <td><span class="genmed" style="font-weight: bold">Quote:</span></td>
	</tr>
	<tr>
...
<table width="90%" cellspacing="1" cellpadding="3" border="0" align="center">
<tr> 
	  <td><span class="genmed" style="font-weight: bold">Code:</span></td>
	</tr>
	<tr>
...
<!-- BEGIN img --><img src="{URL}" border="0" alt="" align="middle" /><!-- END img -->
