...
<tr>
  <td width="50%" valign="top">
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
    <tr>
      <td class="th" align="center"><b>Personal Information</b></td>
    </tr>
    <tr>
      <td class="td" style="padding: 10px; border-right: 1px solid rgb(80,80,130); border-left: 1px solid rgb(80,80,130);">
        <table>
        <tr>
          <td align="right" valign="top">
            <!-- BEGIN avatar -->
            <img src="{avatar.IMG_URL}" style="background-color: rgb(56,56,97); border: 2px solid rgb(56,56,97);" alt="Avatar" title="" />
            <!-- END avatar -->
          </td>
          <td valign="bottom">
            <b>{USERNAME}</b>
    ...
    <table cellspacing="0" cellpadding="0"  width="100%">
    <tr>
      <td class="th" align="center"><b>Statistics</b></td>
    </tr>
    <tr>
      <td class="td" style="padding: 10px; border-right: 1px solid rgb(80,80,130); border-left: 1px solid rgb(80,80,130);">
        <table>
  ...
  <td width="50%" valign="top">
    ...
    <table cellspacing="0" cellpadding="0"  width="100%">
    <tr>
      <td class="th" align="center"><b>Contact Information</b></td>
    </tr>
    <tr>
      <td class="td" style="padding: 10px; border-right: 1px solid rgb(80,80,130); border-left: 1px solid rgb(80,80,130);">
        <table width="100%">
    ...
    <table cellspacing="0" cellpadding="0"  width="100%">
    <tr>
      <td class="th" align="center"><b>Projects on RPGDX</b></td>
    </tr>
    <tr>
      <td class="td" style="padding: 10px; border-right: 1px solid rgb(80,80,130); border-left: 1px solid rgb(80,80,130);">
        <!-- BEGIN projects -->
